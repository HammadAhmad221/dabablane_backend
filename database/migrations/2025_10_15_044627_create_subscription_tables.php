...
return new class extends Migration {
    ...
    //         $table->id();
    //         $table->string('title');
    //         $table->string('slug'); // e.g., "3-Month Pack – Launch Promo"
    //         $table->decimal('price_ht', 10, 2); // Price excluding tax (MAD)
    //         $table->decimal('original_price_ht', 10, 2)->nullable(); // For promo crossed-out price
    //         $table->integer('duration_days'); // Duration in days (e.g., 30, 90, 180)
    //         $table->text('description')->nullable(); // Free text for plan details
    ...
    //     // Configurations (Contacts, Commission PDF, Invoice Template)
    //     Schema::create('configurations', function (Blueprint $table) {
    //         $table->id();
    //         $table->string('key')->unique(); // e.g., facturation_email, contact_email, phone, commission_pdf, invoice_logo
    //         $table->text('value')->nullable(); // Stored value (email, URL, etc.)
    //         $table->timestamps();
    //     });
    // }
